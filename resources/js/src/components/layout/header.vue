            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    ...
                    <li class="nav-item theme-text">
                        <router-link to="/" class="nav-link"> MANO AMIGA <span v-if="$store.getters.isAuthenticated.status.loggedIn"> 👍 {{ $store.getters.isAuthenticated.user.name }}</span></router-link>
                    </li>
                </ul>
                ...
                <div class="navbar-item flex-row ms-md-auto">
                    ...
                    <div v-if="currentUser" class="dropdown nav-item user-profile-dropdown btn-group">
                        <a href="javascript:;" data-bs-toggle="dropdown" aria-expanded="false" class="btn dropdown-toggle btn-icon-only user nav-link">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            ...
                            <li v-if="AuthService.roleAccess('admin')">
